...
import { volunteering } from "../../constants"; // Import your data
            ...
            >
              ...
              <div className="flex items-center space-x-6">
                ...
                <div className="w-16 h-16 bg-white rounded-md overflow-hidden">
                  <img
                    src={volunteering.img}
                    alt={volunteering.company}
                ...
                <div className="flex flex-col justify-between">
                  ...
                  <p className="text-sm text-gray-500 mt-2">{volunteering.date}</p>
                </div>
              </div>

              <p className="mt-4 text-gray-400">{volunteering.desc}</p>
              <div className="mt-4">
                <h5 className="font-medium text-white">Skills:</h5>
                <ul className="flex flex-wrap mt-2">
                  {volunteering.skills.map((skill, index) => (
                    <li
                      key={index}
